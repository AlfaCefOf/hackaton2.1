...
import { FiHeart, FiDollarSign, FiMapPin, FiUsers, FiTarget, FiCreditCard, FiPhone, FiMail } from 'react-icons/fi';
...
const DonationSection = () => {
  ...
  const shelters = [
    {
      ...
      goal: 5000,
      raised: 3500,
      description: "The main animal shelter in Tashkent providing care for abandoned and stray animals.",
      contact: {
    ...
    },
    {
      ...
      goal: 3000,
      raised: 1200,
      description: "Specialized in rescuing and rehabilitating injured and sick animals.",
      contact: {
    ...
    },
    {
      ...
      goal: 8000,
      raised: 2000,
      description: "Dedicated to rescuing and rehabilitating wildlife and exotic animals.",
      contact: {
  ...
  const handleDonationSubmit = () => {
    ...
    alert(`Thank you for your generous donation of $${amount} to ${selectedShelter.name}! Your support helps save animal lives.`);
    ...
    <section className="py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-[#2F3E46] mb-4">Support Animal Shelters</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Your donations provide food, medical care, and shelter for animals in need.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {shelters.map((shelter) => (
            <div key={shelter.id} className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-semibold text-[#2F3E46]">{shelter.name}</h3>
              ...
              <div className="mb-4">
                ...
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    ...
                    style={{width: `${calculateProgress(shelter.raised, shelter.goal)}%`}}
                  ></div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg max-w-md w-full p-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-medium text-gray-800">{selectedShelter.animals} animals</span>
                </div>
              </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-[#A8DADC] to-[#F1FAEE] rounded-lg p-8">
            <h3 className="text-2xl font-bold text-[#2F3E46] mb-4">Make a Difference Today</h3>
            <p className="text-[#2F3E46]/80 mb-6 max-w-2xl mx-auto">
              Your donation provides essential care for animals in need. From food and medical treatment
              to shelter and rehabilitation, every dollar helps save lives.
            </p>
