  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="mb-4">
          <label className="block text-gray-700 mb-2">Found Location</label>
          <input
            type="text"
            name="location"
        ...
        <button type="submit" className="w-full bg-green-600 text-white py-2 rounded hover:bg-green-700">Report Item</button>
      </form>
    </div>
  );
};
