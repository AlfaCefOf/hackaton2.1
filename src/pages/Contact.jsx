          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">support@lostandfound.com</p>
                <p className="text-gray-600 dark:text-gray-300">help@lostandfound.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">+1 (555) 123-LOST</p>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">123 Lost & Found Street</p>
                <p className="text-gray-600 dark:text-gray-300">Recovery City, RC 12345</p>
              </div>
            </div>
          </div>
